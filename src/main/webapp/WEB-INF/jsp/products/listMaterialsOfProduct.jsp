...
<petmaterial:layout pageName="user">
    ...
    <h2>Materiales del producto <c:out value="${product.nombre}"></c:out></h2>
    ...
    <table id="userTable" class="table table-striped">
        ...
        <c:forEach items="${materials}" var="material">
                ...
                <td>
                	<a href="/products/${product.id}/materials/${material.id}/delete">
    ...
    <p>
    	<a href="/products/${product.id}/materials/new" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Añadir material de producto</a>
    </p>
</petmaterial:layout>